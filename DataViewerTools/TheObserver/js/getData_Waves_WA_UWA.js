async function getData_Waves_WA_UWA(loc) {

    const id = loc.Notes.split(',')[0].split('=')[1].trim();

    var data_url = `https://wawaves.org/wp-json/waves/v1/buoys/${id}?type=waves&simplified=1&sources=AKIAQXUN6NGKDLH7EQQN,AKIAQXUN6NGKEAGWLJ7C`
    ...
    const customAttribution = `
        <p>This wave buoy data is provided by the <a href="https://wawaves.org/about" target="_blank">University of Western Australia</a> under a <a href="https://creativecommons.org/licenses/by/4.0/" taret="_blank">Creative Common license (CC BY 4.0)</a>.<br>
                The data is collected in collaboration with: 
                Australia’s Integrated Marine Observing System (IMOS) – IMOS is enabled by the National Collaborative Research Infrastructure Strategy (NCRIS);  
                the Minderoo Foundation – Flourishing Oceans, and Aqualink;
                the City of Wanneroo; 
                the WA Dept. of Jobs, Tourism, Science and Innovation (JTSI) and the WA Department of Primary Industries, and Regional Development (DPIRD).</p>                       
        `;
